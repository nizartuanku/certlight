// certwatch is the shippable product binary: CertWatch on Sentinel Core.
//
//	certwatch                     # serves the dashboard on 127.0.0.1:8422
//	certwatch -listen :8422       # expose beyond localhost (put auth/TLS in front)
//	certwatch -db certwatch.db    # SQLite path (default; ":memory:" for ephemeral)
//
...
func main() {
	...
	fmt.Printf("CertWatch %s — %s edition\n", cw.Describe().Version, act.Tier)
